...
// Mudar Aqui o e-mail
$email_envio = "contato@vagalumes.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "coxinha123"; // Senha do e-mail

$site_name = "Vagalumes"; // Nome do Site
$site_url = "www.vagalumes.com"; // URL do Site
